        ...
        <div class="col-xs-12">
          <div class="box">
			...
			<form method="post" action="">
				...
				<input type="text" class="form-control" name="lecturer_id" value="<?php echo $lecturer->lecturer_id?>">
				</div>				
				<div class="form-group">
					<span class="input-group-addon">Lecturer Username</span>
				<input type="text" class="form-control" maxlength="20" name="lecturer_username" value="<?php echo $lecturer->lecturer_username?>">
				</div>
				<div class="form-group">
					<span class="input-group-addon">Lecturer Name</span>
					<input type="text" class="form-control" maxlength="70" name="lecturer_full_name" value="<?php echo $lecturer->lecturer_full_name?>">
				</div>	
				<div class="form-group">
					<span class="input-group-addon">Lecturer Password</span>
					<input type="text" class="form-control" maxlength="10" name="lecturer_password" value="<?php echo $lecturer->lecturer_password?>">
				</div>			
			</div>
