        ...
        <div class="col-xs-12">
          <div class="box">
			...
			<form method="post" action="">
				...
				<input type="text" class="form-control" name="admin_id" value="<?php echo $admin->admin_id?>">
				</div>				
				<div class="form-group">
					<span class="input-group-addon">Admin Username</span>
				<input type="text" class="form-control" maxlength="20" name="admin_username" value="<?php echo $admin->admin_username?>">
				</div>
				<div class="form-group">
					<span class="input-group-addon">Admin Name</span>
					<input type="text" class="form-control" maxlength="70" name="admin_name" value="<?php echo $admin->admin_name?>">
				</div>	
				<div class="form-group">
					<span class="input-group-addon">Admin Password</span>
					<input type="text" class="form-control" maxlength="10" name="admin_password" value="<?php echo $admin->admin_password?>">
				</div>			
			</div>
