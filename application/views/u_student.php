        ...
        <div class="col-xs-12">
          <div class="box">
			...
			<form method="post" action="">
				...
				<input type="text" class="form-control" name="student_id" value="<?php echo $student->student_id?>">
				</div>				
				<div class="form-group">
					<span class="input-group-addon">Student TP</span>
				<input type="text" class="form-control" maxlength="8" name="student_tp" value="<?php echo $student->student_tp?>">
				</div>
				<div class="form-group">
					<span class="input-group-addon">Student Name</span>
					<input type="text" class="form-control" maxlength="70" name="student_full_name" value="<?php echo $student->student_full_name?>">
				</div>	
				<div class="form-group">
					<span class="input-group-addon">Student Intake</span>
					<input type="text" class="form-control" maxlength="15" name="student_intake" value="<?php echo $student->student_intake?>">
				</div>
				</div>				
			</div>
